...
import { Action, AuthContextValue, AuthProviderProps, DeleteAccountAction, InitializeAction, LoginAction, LogoutAction, RegisterAction, State } from "@auth/AuthInterface"
...
export const AuthProvider: FC<AuthProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    const initialize = async (): Promise<void> => {
      const token: string | null = await authHelpers.getToken()
